...
Coronal Mass Ejection (CME) Analysis, helps get the data of coronal mass ejection events between two date ranges, and will have characteristics of the speed and half angle as defined by the user. Following up on the date retrieved after the API call, we have done the Exploratory Data Analysis to get some hidden and valuable insights of the data.
