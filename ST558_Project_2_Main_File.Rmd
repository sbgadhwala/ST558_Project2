...
asteroidData <- function(start_date, end_date, ...){
  ...
  aesData <- tibble('Magnitude (H)' = magnitude, 
                    'Minimum Diameter (Miles)' = dMin, 
                    'Maximum Diameter (Miles)' = dMax, 
                    'Relative Velocity (Kilometer per hour)' = velocity,
                    'Approach Date' = Date, 
                    'Miss Distance (au)' = missDist,
                    'Orbiting Body' = orbitBody,
                    'Is Potentially Hazardous Asteroid' = isHazard)
